...
export default async function Home() {
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-12 text-center lg:pt-20">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
          Single page shareable portfolio builder for developers. Fill in your
          details, choose template and you are good to go.
        </p>
